...
-   :material-map-clock:{ .lg .middle } __Studiepad__
    ...
    Volg het nieuwe **2-daags noodplan**: eerst basis + instrumenten, daarna derivaten + banken + crisis + regulering.

    [:octicons-arrow-right-24: Start 2-daags studiepad](exam/studiepad-open-vragen.md)
