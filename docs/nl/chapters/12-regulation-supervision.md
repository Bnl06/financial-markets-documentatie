...
!!! abstract "Kernzin"
    ...
    Regulering legt regels op; supervisie controleert of instellingen veilig werken. Na 2008 werd toezicht sterker door systeemrisico en too-big-to-fail-problemen.

## 1. Banking is risky business

Banken lopen verschillende risico's.
...
Na eerdere crises en vooral na 2008 kwamen sterkere regels. Belangrijke domeinen:
...
Basel-regels draaien rond voldoende kapitaal, toezicht en marktdiscipline.
...
De Banking Union bestaat uit mechanismen om banken veiliger te maken en nationale fragmentatie te verminderen.

- **SSM — Single Supervisory Mechanism**: ECB en nationale toezichthouders werken samen. Grote banken worden direct door ECB-supervisie opgevolgd.
...
Leg uit waarom regels alleen niet genoeg zijn. Regulering bepaalt de regels, maar supervisie moet controleren of banken ze juist toepassen en of nieuwe risico's ontstaan.
